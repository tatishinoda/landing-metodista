...
var cursosPresencial = {
   ...
   'Gestão Financeira Tecnólogo': ['Noturno'],
   'História': ['Noturno'],
   'Jornalismo': ['Noturno'],
   ...
   'Música': ['Noturno'],
   'Negócios Internacionais': ['Noturno'],
   'Nutrição': ['Noturno'],
   'Odontologia': ['Noturno'],
   'Pedagogia': ['Noturno'],
   'Psicologia': ['Noturno'],
...
var campusPresencial = {
   'Administração': ['Taquaral', 'Centro'],
   'Arquitetura e Urbanismo': ['Taquaral', 'Santa Barbara d´Oeste'],
   'Ciências Contábeis': ['Taquaral', 'Centro', 'Santa Barbara d´Oeste', 'Lins'],
   'Ciências Econômicas': ['Taquaral'],
   'Cinema e Audiovisual': ['Taquaral'],
   'Design Gráfico': ['Taquaral'],
   'Direito': ['Taquaral', 'Centro', 'Lins'],
   'Educação Física': ['Taquaral'],
   'Enfermagem': ['Taquaral'],
   'Engenharia Civil': ['Santa Barbara d´Oeste'],
   'Engenharia de Alimentos': ['Santa Barbara d´Oeste'],
   'Engenharia de Controle de Automação': ['Santa Barbara d´Oeste'],
   'Engenharia de Produção': ['Santa Barbara d´Oeste'],
   'Engenharia Elétrica': ['Santa Barbara d´Oeste'],
   'Engenharia Mecânica': ['Santa Barbara d´Oeste'],
   'Engenharia Química': ['Santa Barbara d´Oeste'],
   'Farmácia': ['Taquaral'],
   'Fisioterapia': ['Taquaral'],
   'Gastronomia': ['Taquaral'],
   'Gestão Comercial': ['Centro'],
   'Gestão de Recursos Humanos': ['Centro'],
   'Gestão Financeira Tecnólogo': ['Centro'],
   'História': ['Taquaral'],
   'Jornalismo': ['Taquaral'],
   'Letras – Inglês': ['Taquaral'],
   'Logística': ['Centro'],
   'Marketing': ['Centro'],
   'Medicina Veterinária': ['Taquaral'],
   'Música': ['Taquaral'],
   'Negócios Internacionais': ['Centro'],
   'Nutrição': ['Taquaral'],
   'Odontologia': ['Lins'],
   'Pedagogia': ['Taquaral'],
   'Psicologia': ['Taquaral'],
   'Relações Internacionais': ['Centro'],
   'Sistemas de Informação': ['Taquaral']
};
