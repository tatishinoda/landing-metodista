...
//Verifica campos obrigatórios, exibe os corretos e 
   $("[name=crmeduc_modalidade_interesse]").on("change", function () {
      ...
      if (this.value == "191.030.002") { //002 - A distancia
         ...
         $("input#crmeduc_campus_interesse").val("191.030.005");
      } else {
         ...
         $("input#crmeduc_campus_interesse").val("191.030.001");
      }
      $("form").parsley().reset();
    });
